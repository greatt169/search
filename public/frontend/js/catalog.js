                                    ...
                                    {rangeParams.map((param) =>
                                        <article key={param.code} className="card-group-item">
                                            <header className="card-header">
                                                <h6 className="title">{references.properties[param.code].title} </h6>
                                            </header>
                                                        ...
                                                        {param["values"].map((value) =>
                                                            <label key={value.value} className="form-check">
                                                                ...
                                                                <span className="form-check-label">
                                                                    ...
                                                                    {references.properties[param.code]["values"] ?
...
ReactDOM.render(
    <Catalog api={element.dataset.api} filter={element.dataset.filter} references={element.dataset.references}
             debug={true}/>,
    element
);